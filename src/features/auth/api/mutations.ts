...
export function useDisableTotp() {
    return useMutation({
        mutationFn: (dto: DisableTotpInput) =>
            authApi.disableTotp(dto),
    });
}
...
export function useBlockUser() {
    ...
    return useMutation({
        ...
        onSuccess: (_, variables) => {
            ...
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userDetails(variables.id) });
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userOverview(variables.id) });
...
export function useCreateUserNote() {
    ...
    return useMutation({
        ...
        onSuccess: (_, variables) => {
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userNotes(variables.id) });
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userTimeline(variables.id) });
        },
    });
}
...
export function useSuspendUser() {
    ...
    return useMutation({
        ...
        onSuccess: (_, id) => {
            queryClient.invalidateQueries({ queryKey: authQueryKeys.users() });
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userDetails(id) });
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userOverview(id) });
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userStats() });
        },
    });
}
...
export function useRevokeUserSession() {
    ...
    return useMutation({
        ...
        onSuccess: (_, variables) => {
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userSessions(variables.id) });
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userDevices(variables.id) });
        },
    });
}
...
export function useRevokeAllUserSessions() {
    ...
    return useMutation({
        ...
        onSuccess: (_, id) => {
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userSessions(id) });
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userDevices(id) });
        },
    });
}
...
export function useSubmitApproval() {
    ...
    return useMutation({
        ...
        onSuccess: (_, variables) => {
            queryClient.invalidateQueries({ queryKey: ["approval-request", variables.id] });
            queryClient.invalidateQueries({ queryKey: authQueryKeys.users() });
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userDetails(variables.id) });
        },
    });
...
export function useAssignUserRoles() {
    ...
    return useMutation({
        ...
        onSuccess: (_, variables) => {
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userRoles(variables.id) });
            queryClient.invalidateQueries({ queryKey: authQueryKeys.userPermissions(variables.id) });
        },
    });
}
