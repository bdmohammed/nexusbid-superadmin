...
export const authApi = {
    ...
    submitApproval(id: string, input: SubmitApprovalInput) {
        return apiClient.post<ApiResponse<ApprovalRequest>>(`/admin/users/${id}/submit-approval`, input);
    },
    ...
    reviewApproval(id: string, input: ReviewApprovalInput) {
        return apiClient.post<ApiResponse<ApprovalRequest>>(`/admin/users/${id}/review-approval`, input);
    },
