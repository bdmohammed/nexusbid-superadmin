...
export function useAdminUpdateTender() {
    ...
    return useMutation({
        ...
        onSuccess: (_, variables) => {
            queryClient.invalidateQueries({ queryKey: tenderQueryKeys.list() });
            queryClient.invalidateQueries({ queryKey: tenderQueryKeys.adminList() });
            queryClient.invalidateQueries({ queryKey: tenderQueryKeys.adminDetail(variables.id) });
        },
    });
}
...
export function useCancelTender() {
    ...
    return useMutation({
        ...
        onSuccess: (_, id) => {
            queryClient.invalidateQueries({ queryKey: tenderQueryKeys.list() });
            queryClient.invalidateQueries({ queryKey: tenderQueryKeys.adminList() });
            queryClient.invalidateQueries({ queryKey: tenderQueryKeys.adminDetail(id) });
        },
    });
}
...
export function useScheduleTender() {
    ...
    return useMutation({
        mutationFn: async ({ id, input }: { id: string; input: { publishAt: string; closeAt: string } }) => {
...
export function useCreateAmendment() {
    ...
    return useMutation({
        ...
        onSuccess: (_, variables) => {
            queryClient.invalidateQueries({ queryKey: tenderQueryKeys.adminDetail(variables.id) });
            queryClient.invalidateQueries({ queryKey: tenderQueryKeys.history(variables.id) });
        },
    });
}
...
export function useSubmitReviewComment() {
    return useMutation({
        mutationFn: async ({ reviewId, input }: { reviewId: string; input: SubmitReviewCommentDto }) => {
...
export function useSubmitEvaluation() {
    return useMutation({
        mutationFn: async ({ participantId, input }: { participantId: string; input: SubmitEvaluationDto }) => {
