...
function BootstrapContent() {
  ...
  useEffect(() => {
    if (!token) {
      ...
      setErrorMsg(
        "No bootstrap token provided. Please check the setup link sent to your email.",
      );
      return;
    }
  ...
  const handleAction = async (action: "approve" | "reject") => {
    ...
    try {
      ...
      if (!data.success) {
        ...
        setErrorMsg(
          data.message ||
            `${action === "approve" ? "Bootstrap approval" : "Rejection"} failed.`,
        );
        return;
      }
      setActionStatus(
        action === "approve" ? "success_approve" : "success_reject",
      );
      setTimeout(() => {
        router.push("/login");
      }, 5000);
      ...
      setErrorMsg(
        getErrorMessage(err) ||
          `Bootstrap ${action} action failed. Please try again.`,
      );
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-16 bg-[#0a0f1d] relative overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-[40rem] h-[40rem] bg-indigo-600/10 rounded-full blur-[120px] pointer-events-none animate-pulse"
      ...
      <div className="w-full max-w-lg p-8 md:p-10 rounded-3xl bg-white/[0.02] border border-white/[0.06] backdrop-blur-xl shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-gray-400 text-sm md:text-base mb-8 max-w-md mx-auto">
            Review and approve the first administrator to initialize the RFPNexa
            ...
            adminDetails && (
              <div className="space-y-8 animate-fadeIn">
                ...
                <div className="p-4 bg-blue-500/5 border border-blue-500/10 rounded-2xl text-left text-xs text-blue-300 leading-relaxed">
                  <strong>Security Notice:</strong> Approving this setup will
                  activate this administrator account and assign them the
                  highest system privileges. This bootstrap page will be
            ...
            <div className="py-8 space-y-6 animate-scaleUp">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-400 text-sm max-w-sm mx-auto leading-relaxed">
                  The first Super Admin has been configured successfully.
                  Redirecting you to the sign in page to access the admin
                  dashboard...
                </p>
              </div>
          ...
          {actionStatus === "success_reject" && (
            <div className="py-8 space-y-6 animate-scaleUp">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-400 text-sm max-w-sm mx-auto leading-relaxed">
                  The administrator registration request has been rejected
                  successfully. Redirecting you to the sign in page...
                </p>
              </div>
              <div className="flex justify-center pt-2">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-[10px] text-gray-400 uppercase tracking-widest">
