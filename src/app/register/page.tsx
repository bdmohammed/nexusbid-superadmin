...
export default function SetupPage() {
  ...
  const { register: registerUser, isRegistering, user, isAuthenticated } = useAuth();
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 relative z-10" noValidate>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  className={`w-full px-4 py-3 rounded-lg bg-[var(--surface-secondary)] border text-[var(--foreground)] placeholder-[var(--muted)] focus:outline-hidden focus:ring-2 focus:ring-[#003EC7] focus:border-transparent transition-all ${errors.name ? 'border-red-500' : 'border-[var(--border)]'
                    }`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  className={`w-full px-4 py-3 rounded-lg bg-[var(--surface-secondary)] border text-[var(--foreground)] placeholder-[var(--muted)] focus:outline-hidden focus:ring-2 focus:ring-[#003EC7] focus:border-transparent transition-all ${errors.companyName ? 'border-red-500' : 'border-[var(--border)]'
                    }`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="password"
                  className={`w-full px-4 py-3 rounded-lg bg-[var(--surface-secondary)] border text-[var(--foreground)] placeholder-[var(--muted)] focus:outline-hidden focus:ring-2 focus:ring-[#003EC7] focus:border-transparent transition-all ${errors.confirmPassword ? 'border-red-500' : 'border-[var(--border)]'
                    }`}
                  placeholder="••••••••"
            ...
            <div className="flex flex-col mt-2">
              <div className="flex items-start">
                <input
                  ...
                  {...register('terms')}
                />
                <label htmlFor="terms" className="ml-2 text-xs text-[var(--muted)]">
                  I agree to the{' '}
