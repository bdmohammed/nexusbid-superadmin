...
export default function UserRow({
  ...
  return (
    <tr className="border-b border-border transition hover:bg-background">
      ...
      <td className="px-5 py-4 text-sm text-text-light">{user.phone}</td>
      ...
      <td className="px-5 py-4 text-sm text-text-light">{user.lastLogin}</td>

      <td className="px-5 py-4 text-sm text-text-light">{user.created}</td>
